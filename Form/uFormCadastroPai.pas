...
uses
  ...
  FireDAC.Comp.DataSet, Vcl.Buttons, uBiblioteca;
...
begin
  ...
  begin
    ...
    fdQryCodigo.SQL.Clear;
    fdQryCodigo.SQL.Add('SELECT MAX('+vID+') ID FROM ' +GetNameTable(vSqlOriginal));
    fdQryCodigo.SQL.Add(' WHERE '+vID+' < '+IntToStr(vCodigo));
    fdQryCodigo.Open();
